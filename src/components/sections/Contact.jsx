            ...
            <div className="px-4 w-150">
                ...
                <form className="space-y-6" onSubmit={handleSubmit}>
                    <div className="relative">
                        ...
                        required 
                        value={formData.name}
                        className="w-full bg-white/5 border border-white/10 rounded px-4 py-3 text-white transition focus:outline-none focus:border-yellow-500 focus:bg-fuchsia-500/5"
                    ...
                    <button type="submit" className="w-full bg-yellow-600 text-white py-3 px-6 rounded font-medium transition relative overflow-hidden hover:-translate-y-0.5 hover:shadow-[0_0_15px_rgba(59, 130, 246, 0.4)">
                        Send Message
                    </button>
                </form>
            </div>
