                        ...
                        <div className="p-8 rounded-xl border-white/10 border hover:-translate-y-1 transition-all glass">
                            <div className="space-y-6 text-gray-300">
                                <div className="bg-black/20 rounded-lg p-6 border border-yellow-500/20">
                                    ...
                                    <div className="text-lg text-yellow-400 font-medium mb-2">
                                ...
                                <div className="bg-gray-900/40 rounded-lg p-6">
                                    <h4 className="text-fuchsia-400 font-semibold text-lg mb-4 flex items-center gap-2">
                                        <span>📚</span>
                                        Relevant Coursework:
                                    </h4>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 max-w-5xl mx-auto">
                            {workExperience?.map((job, index) => (
                                <div key={job.id} className="p-6 rounded-xl border-white/10 border hover:-translate-y-1 transition-all glass h-84 flex flex-col"> 
                                    ...
                                    <div className="bg-gray-900/40 rounded-lg p-4 flex-grow flex flex-col"> {/* Flex-grow to fill remaining space */}
                                        <h4 className="text-fuchsia-400 font-semibold text-base mb-3 flex items-center gap-2 flex-shrink-0">
                                            <span>💻</span>
